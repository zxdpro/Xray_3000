...
tokenizer = AutoTokenizer.from_pretrained("/mnt/d/GG/ChatGLM-6B-main/visualglm_6b", trust_remote_code=True)
model = AutoModel.from_pretrained("/mnt/d/GG/ChatGLM-6B-main/visualglm_6b", trust_remote_code=True).half().cuda()
model = model.eval()
